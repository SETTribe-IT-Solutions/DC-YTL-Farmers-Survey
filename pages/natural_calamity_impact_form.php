...
<head>
    ...
    <title>नैसर्गिक आपत्ती विषयी माहिती भरा</title>
...
<body>
    ...
    <div class="container-fluid">
        <div class="header">
            <h1><i class="fas fa-users me-3"></i>नैसर्गिक आपत्ती विषयी माहिती</h1>
        </div>
        ...
        <div class="main-container">
            ...
            <form id="familyForm" action="natural_calamity_impact_form_db.php" method="POST" class="needs-validation"
                novalidate>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="form-label required">
                                        नैसर्गिक आपत्तीमध्ये मागील एक वर्षात शेती किंवा पशुपालन याचे नुकसान झाले आहे
                                        काय?
                                    </label>
                                    <div>
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="disaster_loss"
                                                id="mr_yes" value="होय" required>
                                            <label class="form-check-label" for="mr_yes">होय</label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="disaster_loss" id="mr_no"
                                                value="नाही" required>
                        ...
                        <div class="row g-3">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div>
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="compensation_received"
                                                id="compYes" value="होय" required>
                                            <label class="form-check-label" for="compYes">होय</label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="compensation_received"
                                                id="compNo" value="नाही" required>
