        ...
        <div class="main-container">
            ...
            <form id="familyForm" action="annual_income_db.php" method="POST" enctype="multipart/form-data">
                ...
                <div class="sub-section">
                    <h5 class="member-title"><i class="fas fa-rupee-sign info-icon"></i>उत्पन्नाचे स्रोत (वार्षिक)
                    </h5>
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="remarks_farming" class="form-control" placeholder="उदा. 50%">
                            <div class="invalid-feedback"></div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <label class="form-label">टक्केवारी / Remarks</label>
                            <input type="text" name="remarks_livestock" class="form-control" placeholder="उदा. 20%">
                            <div class="invalid-feedback"></div>
                        </div>
...
<div class="col-md-6">
    ...
    <input type="file" name="info_recipient_signature" class="form-control" accept="image/*">
    <div class="invalid-feedback"></div>
</div>

<!-- तपासणी करणाऱ्याचे पूर्ण नाव, पदनाम व स्‍वाक्षरी -->
<div class="col-md-6">
    <label class="form-label">तपासणी करणा-या अधिकारी यांचे पुर्ण नाव व पदनाम व स्‍वाक्षरी</label>
    <input type="file" name="verifier_name_designation_signature" class="form-control" accept="image/*">
    <div class="invalid-feedback"></div>
</div>
