...
<head>
    <title>Farmers Survey Portal - Maharashtra Shashan</title>
                        ...
                        <div class="login-form">
                            <form class="form w-100" method="post" id="kt_sign_in_form" action="login_db.php">
                                ...
                                <div class="text-center mb-8">
                                    <!--begin::Title-->
                                    <h1 class="text-dark mb-3" style="color: #1e3c72 !important;">Login to Farmers
                                        Survey Portal
                                    </h1>
                                    <!--end::Title-->
                                    <!--begin::Subtitle-->
                                    <div class="text-gray-600 fw-semibold fs-5 mb-4">
                                        Access your Farmers Survey applications
                                    </div>
                                    <!--end::Subtitle-->
                                </div>
                                <!--begin::Heading-->
